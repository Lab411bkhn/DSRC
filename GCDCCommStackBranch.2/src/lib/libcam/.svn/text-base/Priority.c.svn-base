...
static asn_INTEGER_enum_map_t asn_MAP_Priority_value2enum_1[] = {
	{ 0,	8,	"reserved" },
	{ 1,	3,	"cam" },
	{ 2,	9,	"emergency" },
	{ 3,	4,	"high" },
...
static unsigned int asn_MAP_Priority_enum2value_1[] = {
	1,	/* cam(1) */
	2,	/* emergency(2) */
	3,	/* high(3) */
	5,	/* low(5) */
...
static asn_INTEGER_specifics_t asn_SPC_Priority_specs_1 = {
	asn_MAP_Priority_value2enum_1,	/* "tag" => N; sorted by tag */
	asn_MAP_Priority_enum2value_1,	/* N => "tag"; sorted by N */
...
asn_TYPE_descriptor_t asn_DEF_Priority = {
	...
	&asn_SPC_Priority_specs_1	/* Additional specs */
};
