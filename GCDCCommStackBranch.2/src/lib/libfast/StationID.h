...
/* StationID */
typedef OCTET_STRING_t	 StationID_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_StationID;
asn_struct_free_f __LIBFAST__StationID_free;
asn_struct_print_f __LIBFAST__StationID_print;
asn_constr_check_f __LIBFAST__StationID_constraint;
ber_type_decoder_f __LIBFAST__StationID_decode_ber;
der_type_encoder_f __LIBFAST__StationID_encode_der;
xer_type_decoder_f __LIBFAST__StationID_decode_xer;
xer_type_encoder_f __LIBFAST__StationID_encode_xer;
per_type_decoder_f __LIBFAST__StationID_decode_uper;
per_type_encoder_f __LIBFAST__StationID_encode_uper;
