 ...
 */
asn_dec_rval_t __LIBFAST__xer_decode(struct asn_codec_ctx_s *opt_codec_ctx,
 ...
 * Used by more specialized functions, such as __LIBFAST__OCTET_STRING_decode_xer_utf8
 * and others. This function should not be used by applications, as its API
 * is subject to changes.
 */
asn_dec_rval_t __LIBFAST__xer_decode_general(asn_codec_ctx_t *opt_codec_ctx,
...
ssize_t __LIBFAST__xer_next_token(int *stateContext,
	const void *buffer, size_t size, pxer_chunk_type_e *_ch_type);

/*
 * This function checks the buffer against the tag name is expected to occur.
 */
  typedef enum __LIBFAST__xer_check_tag {
...
xer_check_tag_e __LIBFAST__xer_check_tag(const void *buf_ptr, int size,
		const char *need_tag);
 ...
 * 0:	Non-whitespace
 */
int __LIBFAST__xer_is_whitespace(const void *chunk_buf, size_t chunk_size);

/*
 * Skip the series of anticipated extensions.
 */
int __LIBFAST__xer_skip_unknown(xer_check_tag_e tcv, ber_tlv_len_t *depth);
