...
#ifndef	_ServContextList_H_
#define	_ServContextList_H_
...
/* ServContextList */
typedef struct ServContextList {
	A_SEQUENCE_OF(struct FastContext) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ServContextList;
