 ...
 *   If you can't always satisfy this requirement, use __LIBFAST__ber_decode(),
 *   __LIBFAST__xer_decode() and __LIBFAST__uper_decode() functions instead.
 */
...
/*
 * Type of the return value of the encoding functions (__LIBFAST__der_encode, __LIBFAST__xer_encode).
 */
...
#define	_ASN_ENCODE_FAILED do {					\
	...
	__LIBFAST__ASN_DEBUG("Failed to encode element %s", td->name);	\
	return tmp_error;					\
} while(0)
...
/*
 * Type of the return value of the decoding functions (__LIBFAST__ber_decode, __LIBFAST__xer_decode)
 * 
...
#define	_ASN_DECODE_FAILED do {					\
	...
	__LIBFAST__ASN_DEBUG("Failed to decode element %s", td->name);	\
	return tmp_error;					\
} while(0)
