 ...
 */
int
__LIBFAST__asn_set_add(void *asn_set_of_x, void *ptr) {
...
void
__LIBFAST__asn_set_del(void *asn_set_of_x, int number, int _do_free) {
	asn_anonymous_set_ *as = _A_SET_FROM_VOID(asn_set_of_x);
 ...
 */
void
__LIBFAST__asn_set_empty(void *asn_set_of_x) {
	asn_anonymous_set_ *as = _A_SET_FROM_VOID(asn_set_of_x);
