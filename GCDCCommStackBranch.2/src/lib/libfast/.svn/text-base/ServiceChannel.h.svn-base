...
#ifndef	_ServiceChannel_H_
#define	_ServiceChannel_H_
...
/* ServiceChannel */
typedef struct ServiceChannel {
	long	 serviceChannel;
	MedType_t	 medium;
	OCTET_STRING_t	 schParams;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_ServiceChannel;

#ifdef __cplusplus
}
#endif

#endif	/* _ServiceChannel_H_ */
