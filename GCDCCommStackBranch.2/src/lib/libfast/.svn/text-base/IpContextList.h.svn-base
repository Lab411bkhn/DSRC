...
#ifndef	_IpContextList_H_
#define	_IpContextList_H_
...
/* IpContextList */
typedef struct IpContextList {
	A_SEQUENCE_OF(struct IpContext) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_IpContextList;
