...
#ifndef	_IpPrefixList_H_
#define	_IpPrefixList_H_
...
/* IpPrefixList */
typedef struct IpPrefixList {
	A_SEQUENCE_OF(struct IpPrefix) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_IpPrefixList;
