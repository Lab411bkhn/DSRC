...
#ifndef	_IpServList_H_
#define	_IpServList_H_
...
/* IpServList */
typedef struct IpServList {
	A_SEQUENCE_OF(struct IpService) list;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_IpServList;
