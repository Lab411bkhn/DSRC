...
asn_outmost_tag_f __LIBFAST__asn_TYPE_outmost_tag;
 ...
 * (See also __LIBFAST__xer_fprint() in xer_encoder.h)
 */
int __LIBFAST__asn_fprint(FILE *stream,		/* Destination stream descriptor */
